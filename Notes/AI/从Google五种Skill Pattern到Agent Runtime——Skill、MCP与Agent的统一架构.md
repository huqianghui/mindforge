...
![五种 Skill 设计模式概览](../../asset/skill-patterns-overview.png)
...
![Skill Pattern 与 Agent Pattern 的关系](../../asset/skill-vs-agent-pattern.png)
...
![Agent / MCP / Skill 统一架构](../../asset/agent-mcp-skill-unified-architecture.png)
