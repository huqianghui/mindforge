...
这也印证了 [[架构师视角的AI Harness Engineering最佳实践]] 中提出的观点：Harness Engineering 的核心不是发明新概念，而是在五个已知维度上做到足够深——Tool 要安全、Knowledge 要按需、Observation 要压缩、Interface 要结构化、Permission 要分层。
...
- [[架构师视角的AI Harness Engineering最佳实践]] — Harness Engineering 的实践框架与五大支柱
- [[AI-Native开发实践：从Figma设计到Superpowers Brainstorm再到Spec-Delta工作流]] — 五层 AI pipeline 全景
