---
title: 控制论、强化学习与在线学习——三个容易混淆的 Agent 概念澄清
created: 2026-04-17
tags:
  - cybernetics
...
# 控制论、强化学习与在线学习——三个容易混淆的 Agent 概念澄清

> 在 AI Agent 工程中，"负反馈"、"奖励函数"、"损失函数"、"在线学习"经常被混为一谈。本文基于与 [ChatGPT 的深度讨论](https://chatgpt.com/share/69e238d8-280c-839c-8d07-735b95eb5c79)，系统澄清控制论、强化学习、优化（训练）和在线学习四个概念之间的本质区别与联系。
>
