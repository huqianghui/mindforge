...
| 维度 | 数量 |
|------|------|
| 文章与笔记 | 153（Notes 124 / paper 13 / book 4 / product 4 / Azure 8） |
| 日记 | 131 |
| Wiki 页面 | 96 concepts + 19 methods + 8 decisions |
| Claims（带证据的论断） | 581 |
| 知识图谱 | 123 节点 / 416 关系 / 9 种关系类型 |

> 统计由 `wiki/scripts/export-graph.py` 自动生成，更新于 2026-09-05。
<!-- STATS:END -->
