...
| 维度 | 数量 |
|------|------|
| 文章与笔记 | 146（Notes 117 / paper 13 / book 4 / product 4 / Azure 8） |
| 日记 | 125 |
| Wiki 页面 | 96 concepts + 18 methods + 8 decisions |
| Claims（带证据的论断） | 566 |
| 知识图谱 | 122 节点 / 414 关系 / 9 种关系类型 |

> 统计由 `wiki/scripts/export-graph.py` 自动生成，更新于 2026-08-30。
<!-- STATS:END -->
