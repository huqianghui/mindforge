...
| 维度 | 数量 |
|------|------|
| 文章与笔记 | 115（Notes 92 / paper 12 / book 4 / product 4 / Azure 3） |
| 日记 | 89 |
| Wiki 页面 | 80 concepts + 15 methods + 7 decisions |
| Claims（带证据的论断） | 414 |
| 知识图谱 | 102 节点 / 340 关系 / 9 种关系类型 |

> 统计由 `wiki/scripts/export-graph.py` 自动生成，更新于 2026-07-07。
<!-- STATS:END -->
