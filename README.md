...
| 维度 | 数量 |
|------|------|
| 文章与笔记 | 130（Notes 102 / paper 13 / book 4 / product 4 / Azure 7） |
| 日记 | 108 |
| Wiki 页面 | 84 concepts + 17 methods + 8 decisions |
| Claims（带证据的论断） | 461 |
| 知识图谱 | 109 节点 / 359 关系 / 9 种关系类型 |

> 统计由 `wiki/scripts/export-graph.py` 自动生成，更新于 2026-08-01。
<!-- STATS:END -->
