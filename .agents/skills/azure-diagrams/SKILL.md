...
compatibility: Requires graphviz system package and Python diagrams library. Works with Codex, GitHub Copilot, VS Code, and any Agent Skills compatible tool.
license: MIT
metadata:
  author: community
  version: "3.0"
...
For Codex / GitHub Copilot, save to outputs:
```python
