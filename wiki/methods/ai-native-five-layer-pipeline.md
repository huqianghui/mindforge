...
- [[ai-native-pipeline]] — `implements` 此方法的概念定义页
- [[harness-engineering]] — `implements` Pipeline 是 Harness Engineering 的具体工作流实现
- [[framework-selection]] — `uses` Pipeline 各阶段对应不同框架选型

## 关联方法

- [[cybernetics-harness-design-sheet]] — `contrasts` 五层 Pipeline 是工程结构视角，Design Sheet 是控制论设计维度视角

## 来源

- [[Vibe Coding系列03：AI-Native开发实践——从Figma设计到Superpowers Brainstorm再到Spec-Delta工作流|Vibe Coding系列03]] — AI-Native 开发实践：从 Figma 到 Spec-Delta 工作流
